...
def main():
    '''PDB must be numbered continuously'''
    ...
    parser.add_option("-a","--Ala",type="int",dest="alaRegions",nargs=2,help="Beginning and end residue numbers for both polyA regions of T7 endoI",metavar="ABeg AEnd BBeg BEnd")
    ...
    AlaRegion = options["alaRegion"]
    

    
def addConstraints(structure,PXChains=["C","D","E","F"]):
    constraints = []
